...
This project is indexed by GitNexus as **windhoox** (943 symbols, 1291 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
