...
This project is indexed by GitNexus as **windhoox** (519 symbols, 684 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
