...
This project is indexed by GitNexus as **windhoox** (63 symbols, 57 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
